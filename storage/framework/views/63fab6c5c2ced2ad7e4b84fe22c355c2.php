...
<div x-data="{ cartOpen: false , isOpen: false }" class="bg-white">
        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex items-center justify-between">
                <div class="hidden w-full text-gray-600 md:flex md:items-center">
                    ...
                    <span class="mx-1 text-sm"><?php echo e($business->address); ?></span>
                </div>
                <div class="w-full text-gray-700 md:text-center text-3xl font-bold">
            ...
            <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
                <div class="flex flex-col sm:flex-row">
                    ...
                    <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="#">Services</a>
    ...
    <footer class="bg-gray-200">
        <div class="container mx-auto px-6 py-3 flex justify-between items-center">
            <a href="#" class="text-xl font-bold text-gray-500 hover:text-gray-400"><?php echo e($business->name); ?></a>
            <p class="py-2 text-gray-500 sm:py-0">All rights reserved</p>
        </div>
    </footer>
</div><?php /**PATH C:\Users\karim\Documents\work\vendify\resources\views/business/show.blade.php ENDPATH**/ ?>