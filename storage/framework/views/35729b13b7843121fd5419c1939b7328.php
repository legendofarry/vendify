...
<?php $component->withAttributes([]); ?>
   <?php $__env->slot('header', null, []); ?> 
    <div style="display: flex; justify-content: space-between">
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        ...
        <span class="text-sm text-gray-600 mx-2">(<?php echo e(__('Vendor')); ?>)</span>
        <?php elseif(Auth::user()->hasRole('customer')): ?>
        <span class="text-sm text-gray-600 mx-2">(<?php echo e(__('Customer')); ?>)</span>
        <?php endif; ?>
      </h2>

      <?php if(Auth::user()->hasRole('vendor')): ?>
      <form action="<?php echo e(route('business.create')); ?>" method="GET">
        <?php echo csrf_field(); ?>
        <button type="submit" style="width: 190px; gap:6px" class="px-6 py-2 text-m font-medium text-black inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
          <svg style="height: 17px; width: 17px" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
            <title />
            <g>
  ...
  <div class=" max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700" style="width: 60%; margin: 50px auto;">

    <ul class="my-4 space-y-3" style="display: flex; justify-content: space-between">
      <li>
        <?php if(auth()->user()->role !== 'customer'): ?>
        <a href="<?php echo e(route('product.form')); ?>" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
          <svg aria-hidden="true" class="h-5" viewBox="0 0 292 292" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <?php else: ?>
        <a href="#" class="flex items-center p-3 text-base font-bold text-gray-400 rounded-lg bg-gray-50 cursor-not-allowed">
          <svg aria-hidden="true" class="h-5" viewBox="0 0 292 292" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M145.7 291.66C226.146 291.66 291.36 226.446 291.36 146C291.36 65.5541 226.146 0.339844 145.7 0.339844C65.2542 0.339844 0.0400391 65.5541 0.0400391 146C0.0400391 226.446 65.2542 291.66 145.7 291.66Z" fill="#3259A5" />
            <path d="M195.94 155.5C191.49 179.08 170.8 196.91 145.93 196.91C117.81 196.91 95.0204 174.12 95.0204 146C95.0204 117.88 117.81 95.0897 145.93 95.0897C170.8 95.0897 191.49 112.93 195.94 136.5H247.31C242.52 84.7197 198.96 44.1797 145.93 44.1797C89.6904 44.1797 44.1104 89.7697 44.1104 146C44.1104 202.24 89.7004 247.82 145.93 247.82C198.96 247.82 242.52 207.28 247.31 155.5H195.94Z" fill="white" />
          </svg>
      ...
      <li>
        <a href="<?php echo e(route('business.all')); ?>" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
          ...
          <span class="flex-1 ms-3 whitespace-nowrap">My Businesses</span>
        </a>
      </li>

      <li>
        <?php if(auth()->user()->role !== 'customer'): ?>
        <a href="<?php echo e(route('service.form')); ?>" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
          <svg aria-hidden="true" class="h-4" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span class="flex-1 ms-3 whitespace-nowrap">Create Service</span>
        </a>
        <?php else: ?>
        <a href="#" class="flex items-center p-3 text-base font-bold text-gray-400 rounded-lg bg-gray-50 cursor-not-allowed">
          <svg aria-hidden="true" class="h-4" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <ul style="display: flex; justify-content: space-between">
      <li>
        <a href="<?php echo e(route('product.all')); ?>" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
          <svg aria-hidden="true" svg class="h-5" viewBox="0 0 75.591 75.591" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <li>
        <a href="<?php echo e(route('service.all')); ?>" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
          <svg aria-hidden="true" class="h-5" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <defs>
          ...
          <span class="flex-1 ms-3 whitespace-nowrap">View Services</span>
        </a>
      </li>
    </ul>
  </div>
...
<style>
  ...
  button:hover {
    ...
    /* Set the hover background color to gold */
    color: white !important;
    /* Optional: Change the text color on hover */
    box-shadow: 0 4px 10px rgba(255, 223, 0, 0.5);
    /* Add a subtle glow effect */
  }
</style><?php /**PATH C:\Users\karim\Documents\work\vendify\resources\views/dashboard.blade.php ENDPATH**/ ?>